...
xg_auc1 = read.csv("tuning/new_all_feature_round2/xg_auc1.csv")
xg_auc2 = read.csv("tuning/new_all_feature_round2/xg_auc2.csv")
xg_auc3 = read.csv("tuning/new_all_feature_round2/xg_auc3.csv")
xg_auc4 = read.csv("tuning/new_all_feature_round2/xg_auc4.csv")
xg_auc5 = read.csv("tuning/new_all_feature_round2/xg_auc5.csv")
...
trn = left_join(trn, ftrn %>% select(ID, f_diff_var_15_var_36_cutpoint_smaller,
                                     ind_comb_rank, f_diff_var_15_var_38))
tst = left_join(tst, ftst  %>% select(ID, f_diff_var_15_var_36_cutpoint_smaller,
                                      ind_comb_rank, f_diff_var_15_var_38))
y = trn$TARGET
trn$TARGET=NULL
x = Matrix(as.matrix(trn[, -1]), sparse = TRUE)
...
write.csv(res.df, "../../submission/sumision_xgboost0427.csv", row.names = FALSE, quote = FALSE)
